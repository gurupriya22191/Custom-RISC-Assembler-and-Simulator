...
def instruction(ls, ln, l, dic, var_dic, extra_var, line_number):
    ...
    if len(l) == 4:
        d1 = {"add": "00000", "sub": "00001", "mul": "00110", "xor": "01010",
              "or": "01011", "and": "01100", "addf": "10000", "subf": "10001"}
        if l[0] in d1:
            # print(d1[l[0]],end="")
            # print("00",end="")
            ...
            if l[1] in dic:
                ...
                if l[2] in dic:
                    ...
                    if l[3] in dic:
                        ...
                        print_list.append("False")
                        print("Error line number", line_number+1,
                              ":", l[3], "->wrong register name")
                        flag2 = False
                else:
                    print_list.append("False")
                    print("Error line number", line_number+1,
                          ":", l[2], "->wrong register name")
                    flag2 = False
            else:
                print_list.append("False")
                print("Error line number", line_number+1,
                      ":", l[1], "->wrong register name")
                flag2 = False
        elif ":" in l[0]:
            lst10 = []
            for k in range(1, len(l)):
            ...
            print_list.append("False")
            print("Error line number", line_number+1,
                  ": Instruction not supported by ISA")
            flag2 = False
        ...
        if l[0] == "hlt":
            ...
            if l[0].strip() in dic or l[0].strip() in d1:
                ...
                print("Error line number", line_number+1, ":",
                      l[0], "->Instruction not supported by ISA")

    elif len(l) == 3:

        if "$" in l[2]:

            d3 = {"mov": "00010", "rs": "01000",
                  "ls": "01001", "movf": "10010"}
                ...
                if l[1] in dic:
                    ...
                    if l[2][1:].isnumeric():
                        ...
                        if len(cd1) <= 7:
                            ...
                            print_list.append("False")
                            print("Error line number", line_number+1,
                                  ": Immediate value exceeded 7 bits")
                        ...
                        if l[2][1:-1] < "0.12109376" and l[2][1:-1] > "0.00390624":
                            cd1 = int(fp_lst[0])
                            ...
                            print_list.append("\n")
                        # normal range [0.125,31.5] :
                        else:
                            # print("fjdjfhsdjkfhsdf")
                            cd1 = int(fp_lst[0])
                            cd1 = bin(cd1).replace("0b", "")
                            binary_num = ""
                            cd2 = (fp_lst[1])
                        ...
                        #     print_list.append("False")
                        #     print("Error line number", line_number+1,
                        #           ":", l[2][1:], "->Invalid immediate")

                    else:
                        print_list.append("False")
                        print("Error line number", line_number+1, ":",
                              l[2][1:], "->Invalid immediate(not integer)")
                else:
                    print_list.append("False")
                    print("Error line number", line_number+1,
                          ":", l[1], "->Invalid register name")
                ...
                if l[0] in d4:
                    ...
                    if l[1] in dic:
                        ...
                        if l[2] in dic:
                            ...
                            print_list.append("False")
                            print("Error line number", line_number+1, ":",
                                  l[2], "->Invalid register name or invalid variable name")
                            flag2 = False
                    else:
                        print_list.append("False")
                        print("Error line number", line_number+1,
...
dic = {"R0": "000", "R1": "001", "R2": "010", "R3": "011",
...
for i in range(k, len(red)):
    ...
    if l[0] != "var":
        ...
        print_list.append("False")
        print("Error line number", i+1,
              ": Variable can not be defined in between")
